let defaults = {
  ...
  useDagreCurves: true, // uses dagre's midpoints and the associated bezier curves instead of cytoscape edge styling
  debugDagreCurves: true, // visualizes dagre's Bezier control points
