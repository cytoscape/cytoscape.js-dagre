...
(function (global, factory) {
  ...
  DagreLayout.prototype.run = function () {
    var _rawBb$x, _rawBb$y, _rawBb$x2, _rawBb$y2, _rawBb$w, _rawBb$h;
    ...
    var rawBb = options.boundingBox || {};
    var bb = {
      x1: (_rawBb$x = rawBb.x1) !== null && _rawBb$x !== void 0 ? _rawBb$x : 0,
      y1: (_rawBb$y = rawBb.y1) !== null && _rawBb$y !== void 0 ? _rawBb$y : 0,
      x2: (_rawBb$x2 = rawBb.x2) !== null && _rawBb$x2 !== void 0 ? _rawBb$x2 : rawBb.x1 !== undefined && rawBb.w !== undefined ? rawBb.x1 + rawBb.w : cy.width(),
      y2: (_rawBb$y2 = rawBb.y2) !== null && _rawBb$y2 !== void 0 ? _rawBb$y2 : rawBb.y1 !== undefined && rawBb.h !== undefined ? rawBb.y1 + rawBb.h : cy.height(),
      w: 0,
      h: 0
    };
    bb.w = (_rawBb$w = rawBb.w) !== null && _rawBb$w !== void 0 ? _rawBb$w : bb.x2 - bb.x1;
    bb.h = (_rawBb$h = rawBb.h) !== null && _rawBb$h !== void 0 ? _rawBb$h : bb.y2 - bb.y1;
    ...
    var constrainPos = function constrainPos(p) {
      if (options.boundingBox) {
        var _bb$x, _bb$w, _bb$y, _bb$h;
        var xPct = dagreBB.w === 0 ? 0 : (p.x - dagreBB.x1) / dagreBB.w;
        var yPct = dagreBB.h === 0 ? 0 : (p.y - dagreBB.y1) / dagreBB.h;
        return {
          x: ((_bb$x = bb.x1) !== null && _bb$x !== void 0 ? _bb$x : 0) + xPct * ((_bb$w = bb.w) !== null && _bb$w !== void 0 ? _bb$w : 0),
          y: ((_bb$y = bb.y1) !== null && _bb$y !== void 0 ? _bb$y : 0) + yPct * ((_bb$h = bb.h) !== null && _bb$h !== void 0 ? _bb$h : 0)
        };
      } else {
        return p;
      }
  ...
  if (typeof window !== 'undefined' && window.cytoscape !== 'undefined') {
